...
class CustomerScreenTablet extends StatefulWidget {
  const CustomerScreenTablet({super.key});

  @override
  State<CustomerScreenTablet> createState() => _CustomerScreenTabletState();
}

class _CustomerScreenTabletState extends State<CustomerScreenTablet> {
